...
import { AdminMovie, patchAdminMovieAPI } from '@/api/admin/movie.api';
...
type AdminEditMovieFormProps = {
  movie: AdminMovie;
  setMovie: React.Dispatch<React.SetStateAction<AdminMovie>>;
};

export function AdminEditMovieForm({
  movie,
  setMovie,
}: AdminEditMovieFormProps) {
  ...
  function onSubmit(values: z.infer<typeof formSchema>) {
    const newMovie = { ...values, id: movie.id, staffs: movie.staffs };
    patchAdminMovieAPI(newMovie).then(() => {
      setMovie(newMovie);
      setOpen(false);
    });
  }
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      <Form {...form}>
        ...
        <DialogContent className="w-sm">
          <DialogHeader>
            <DialogTitle>영화 상세</DialogTitle>
            <DialogDescription>검토 후 수정하세요</DialogDescription>
          </DialogHeader>
          <form
